                              ...
                              if (err) {
                                ...
                                cartopartiesCreated[0].cities.add(cities[0],
                                  ...
                                  cartopartiesCreated[1].cities.add(cities[1],
                                    ...
                                    Category.create([{
                                      name: 'Bancs publics',
                                      description: 'Bancs avec un accès libre'
                                    }, {
                                      name: 'Toilettes publiques',
                                      description: 'Uniquement les toilettes sur la place publique'
                                    }, {
                                      name: 'Parcs',
                                      description: 'Parcs en accès libre ou payant'
                                    }, {
                                      name: 'Boîtes aux lettres',
                                      description: 'Boîtes aux lettres de la Poste'
                                    }, {
                                      name: 'Pharmacies',
